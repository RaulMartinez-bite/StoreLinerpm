    ...
    <div class="card shadow cartitems">
        @if($cartitems->count() > 0)
            ...
            <div class="card-footer">
                ...
                <a href="{{ url('checkout') }}" class="btn btn-outline-success float-end">Ver los detalles</a>
                </h6>
            </div>
        @else
            <div class="card-body text-center">
                <h2>Tu <i class="fa fa-shopping-cart"></i> Carrito Vacio</h2>
                <a href="{{ url('category') }}" class="btn btn-outline-primary float-end">Continua con la compra</a>
            </div>
